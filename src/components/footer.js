...
import googlePartner from '../img/google_partner.png'
  ...
  <Container as="footer">
    ...
    <section className={styles.container}>
      <div className='grid grid-rows-2 items-center my-20'>
        ...
        <div className='rounded-t-lg overflow-hidden text-center p-4 mt-3'>
          <button type="button" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-6 border border-blue-700 rounded text-base'>立即報價</button>
        </div>
      </div>
    </section>
    <section className='bg-neutral-200 px-11'>
      <div className='grid grid-cols-6'>
        <div className=''>
          <img className='rounded-sm w-48' src={Native_logo} alt="service_Video_Production"/>
        </div>
        ...
        <div className=''>
          <img className='rounded-sm w-48 float-right' src={googlePartner} alt="service_Video_Production"/>
        </div>
      </div>
    </section>
  </Container>
